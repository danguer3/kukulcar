...
class Control:
    ...
    # INIT OBJECTS
    def __init__( self ):
        self.cruise_speed = 0.28
        self.steering_angle = 0.0

    # CONTROL LAW FOR LANE TRACKING & KEEP DISTANCE
    def control_law(self, left_border, right_border, speed, f_speed):
        if(len(left_border)!=2 or len(right_border)!=2):
            return 
        # NO LINES DETECTED
    ...
    def compute_steering_angle(self, left_border, right_border, side):
        ...
        if side:                                                                    # IF ONLY THERE ARE LEFT LINES
            ...
            goal_distance, goal_angle = [390.48463478093475, 0.3741437906491958]     # GOAL MEASURES FOR LEFT LINES

        else:                                                                       # IF ONLY THERE ARE RIGHT LINES
            detected_distance, detected_angle = right_border                        # DETECTED MEASURES FOR RIGHT LINES
            goal_distance, goal_angle = [310.22733599732953, 0.4000969375753488]    # GOAL MEASURES FOR RIGHT LINES
    ...
    def compute_steering_angle_avg(self, left_border, right_border):
        ...
        goal_dist_left, goal_angle_left =  [390.48463478093475, 0.3741437906491958]     # GOAL MEASURES FOR LEFT LINES
        goal_dist_right, goal_angle_right = [310.22733599732953, 0.4000969375753488]  # GOAL MEASURES FOR RIGHT LINES
        ...
        if ed == 0.0 or ea == 0.0:                                                    # THE CAR IS ALIGNED
            ...
            steering = ((kd * ed) + (ka * ea))/3                                          # CALCULATE STEERING ACCORDING THE AVGS
