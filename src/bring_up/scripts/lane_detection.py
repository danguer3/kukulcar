...
def callback_lane_detect(msg):
    ...
    global polar_left_border, polar_right_border,angle
	...
	angle = polar_left_border[1],polar_right_border[1]
...
def main():
    ...
    # PUBLISHERS
    pub_angle = rospy.Publisher('/steering_angle', Float64MultiArray, queue_size=10)
